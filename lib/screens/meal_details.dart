...
class MealDetailsScreen extends ConsumerWidget {
  ...
  void _favoriteIconPressEventHandler(BuildContext context, WidgetRef ref) {
    final wasAdded =
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
            wasAdded ? 'Marked as favorite' : 'Meal is no longer a favorite'),
      ),
    );
  }
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
              onPressed: () => _favoriteIconPressEventHandler(context, ref),
